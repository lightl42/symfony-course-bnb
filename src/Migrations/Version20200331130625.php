 ...
 */
final class Version20200331130625 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking CHANGE created_at created_at DATETIME NOT NULL, CHANGE amount amount DOUBLE PRECISION NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE amount amount DOUBLE PRECISION DEFAULT NULL');
    }
}
